      ...
      try {
        const imagePromises = [
          ...
          new Promise<void>((resolve, reject) => {
            const img = new Image()
            img.onload = () => resolve()
            img.onerror = () => reject(new Error("Failed to load waving image"))
            img.src = "/images/see-you-soon-waving.png" // New image
          }),
        ]
  ...
  return (
    ...
    >
      ...
      <div className="booking-container mx-auto py-4 relative z-10">
        ...
        {/* New main layout for image and booking content */}
        <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-8 px-4">
          {/* Left Column: Image */}
          ...
          {/* Right Column: Booking Content */}
          <div className="experimental-booking-layout">
