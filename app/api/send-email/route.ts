        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px;">
          ...
          <div style="padding: 0 20px;">
            ...
            <div style="background-color: #e8f5e8; padding: 25px; border-radius: 8px; border: 1px solid #4caf50; margin-bottom: 25px;">
              <h3 style="color: #4caf50; margin-top: 0; margin-bottom: 15px;">What's Next?</h3>
              <ul style="color: #666; line-height: 1.6; margin: 0; padding-left: 20px;">
                <li>We'll contact you within 24 hours to confirm your sessions</li>
                <li>Payment details and instructions will be provided</li>
                <li>You'll receive calendar invites for each session</li>
